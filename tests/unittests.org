...
|  aaaaaaaaaaa | aaaaaaaa▏aa      |
| aaaaaaaaaaaa | aaaaaaaa▏aaa     |
|            ? | (58.0 74.0 90.0) |
#+TBLFM: $2='(orgtbl-ascii-plot-with-vert (or $1 "") 58.0 90.0 16 8)

* dates
dates are converted in number of seconds since [1970-01-01 00:00]
(with possible offsets if there is a daylight saving time set)
...
| [2029-11-23] | ██▉██▉██▉██▏ |
| [2030-02-10] | ██▉██▉██▉██▋ |
#+TBLFM: $2='(orgtbl-ascii-plot-with-vert (or $1 "") 1729152000.0 1902067200.0 12  3 6 9)
